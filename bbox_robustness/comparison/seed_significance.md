...
|---|---:|---|---:|---:|:--:|---:|---:|---:|---:|:--:|
| **C1a-isic** | 15 | +0.0785 ± 0.0295 | +10.316 | 0.0000 | ✓ | 5000 | 11879946 | 0.00e+00 | +0.0636 | ✓ |
| **C1b-ph2** | 15 | +0.0683 ± 0.0310 | +8.543 | 0.0000 | ✓ | 1000 | 484123 | 7.57e-145 | +0.0594 | ✓ |
| **C2-cbis** | 3 | +0.3191 ± 0.0096 | +57.798 | 0.0001 | ✓ | — | — | — | — | — |
| **C3-cbis-zeroshot-ge-rand100** | 15 | -0.0667 ± 0.0257 | -10.043 | 1.0000 | ✓ | 1810 | 245304 | 1.00e+00 | -0.0481 | ✓ |
...
- For C1a/C1b/C2: we expect both `seed pass` and `img pass` to be ✓.
- For C3: we expect both to be ✓, meaning the data does NOT support 'rand100 > zero_shot on CBIS-DDSM at pm=200' — consistent with the claim 'zero_shot ≥ rand100'.
